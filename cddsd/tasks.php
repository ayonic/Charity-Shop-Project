...
$tasks = db_fetch_all("SELECT t.*, u.first_name, u.last_name FROM tasks t LEFT JOIN users u ON t.volunteer_id = u.id ORDER BY t.created_at DESC");
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="py-6">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="add_task.php" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md flex items-center">
                                ...
                                <li>
                                    <div class="px-4 py-4 sm:px-6 flex items-center justify-between">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <a href="delete_task.php?id=<?php echo $task['id']; ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to delete this task?');">
